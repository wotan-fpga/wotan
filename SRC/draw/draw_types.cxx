...
void t_draw_coords::alloc_tile_x_y(int grid_size_x, int grid_size_y){
	this->tile_x.assign(grid_size_x, UNDEFINED);
	this->tile_y.assign(grid_size_y, UNDEFINED);
}
...
//}
//
t_bound_box t_draw_coords::get_absolute_clb_bbox(int grid_x, int grid_y) {
	t_bound_box result(this->tile_x[grid_x], this->tile_y[grid_y], this->tile_x[grid_x] + this->get_tile_width(), this->tile_y[grid_y] + this->get_tile_width());
